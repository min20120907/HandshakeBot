...
choice.add("寒天晶球");
choice.add("小紫蘇");
choice.add("小芋圓(芋圓+薯圓)");
choice.add("布丁");
choice.add("愛玉");
choice.add("搖果樂(珍珠+椰果+荔枝凍)");
choice.add("新雙Q(珍珠+芋圓+薯圓)");
choice.add("暗黑水晶");
choice.add("椰果");
choice.add("珍珠");
choice.add("珍珠L");
...
choice.add("門陣(門市限定)");
		...
		choice_1.add("寒天晶球");
		choice_1.add("小紫蘇");
		choice_1.add("小芋圓(芋圓+薯圓)");
		choice_1.add("布丁");
		choice_1.add("愛玉");
		choice_1.add("搖果樂(珍珠+椰果+荔枝凍)");
		choice_1.add("新雙Q(珍珠+芋圓+薯圓)");
		choice_1.add("暗黑水晶");
		choice_1.add("椰果");
		choice_1.add("珍珠");
		choice_1.add("珍珠L");
		...
		choice_1.add("粉圓L");
		choice_1.add("粉圓M");
		choice_1.add("紅豆(冬季限定)");
		choice_1.add("紫米(冬季限定)");
		choice_1.add("芋頭");
		choice_1.add("荔枝凍");
		choice_1.add("蘆薈");
		choice_1.add("蜜香凍");
		choice_1.add("西谷米");
		choice_1.add("迷你珍珠(門市限定)");
		choice_1.add("門陣(門市限定)");
